...
if __name__ == '__main__':
    ...
    subprocess.run(f'python cli.py train --dataroot {root_folder} --name Test_Model_wmla_$APP_ID --remote True --remote-transfer-cmd storage_volume_utils.upload --batch-size 3 --gpu-ids 0 --display-env $APP_ID',shell=True)
